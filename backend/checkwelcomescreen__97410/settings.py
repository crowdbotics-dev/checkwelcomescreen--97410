"""
Django settings for checkwelcomescreen__97410 project.
...
ROOT_URLCONF = 'checkwelcomescreen__97410.urls'
...
WSGI_APPLICATION = 'checkwelcomescreen__97410.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "checkwelcomescreen__97410 API",
    "DESCRIPTION": "API documentation for checkwelcomescreen__97410 App",
    "VERSION": "v1",
}
