...
## Project Structure
    ...
    ├── checkwelcomescreen__97410  # Django project configurations
...
1. Clone this repo and `cd checkwelcomescreen__97410`
...
2. Clone this repo and `cd checkwelcomescreen__97410`
